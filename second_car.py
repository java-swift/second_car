...
# print(y_train)
model = XGBRegressor(max_depth=300, learning_rate=0.01, n_estimators=700,
...
cv_params = {'n_estimators': [500, 550, 600, 650, 700], 'max_depth': [3, 4, 5, 6, 7, 8, 9, 10], 'min_child_weight': [6, 7, 8],
